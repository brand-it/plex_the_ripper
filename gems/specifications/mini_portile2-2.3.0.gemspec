...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0')
      ...
      s.add_development_dependency('concourse'.freeze, ['~> 0.12'])
      s.add_development_dependency('minitar'.freeze, ['~> 0.5'])
      s.add_development_dependency('minitest'.freeze, ['~> 5.8'])
      s.add_development_dependency('minitest-hooks'.freeze, ['~> 1.4'])
      s.add_development_dependency('rake'.freeze, ['~> 12.0'])
    else
      s.add_dependency('bundler'.freeze, ['~> 1.7'])
      s.add_dependency('minitest-hooks'.freeze, ['~> 1.4'])
      s.add_dependency('minitest-hooks'.freeze, ['~> 1.4'])
      s.add_dependency('minitest-hooks'.freeze, ['~> 1.4'])
      s.add_dependency('minitest-hooks'.freeze, ['~> 1.4'])
      s.add_dependency('rake'.freeze, ['~> 12.0'])
    end
  else
    s.add_dependency('bundler'.freeze, ['~> 1.7'])
    s.add_dependency('concourse'.freeze, ['~> 0.12'])
    s.add_dependency('minitar'.freeze, ['~> 0.5'])
